...
listadeclientes = [
    Cliente(1, 'maria', 11, '4002892200', 'P. Física'),
    Cliente(2, 'luan', 12, '3334442220', 'P. Jurídica'),
    Cliente(3, 'nath', 13, '0119574231', 'P.Física')
]

listadeprodutos = [
    Produto(1, 5, 'fardas', 20.50),
    Produto(2, 10, 'mesas', 10.00),
    Produto(3, 15, 'batom', 50.00),
    Produto(4, 20, 'cacau', 10.00)
]
